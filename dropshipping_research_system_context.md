...
## 🛰️ ЖИВИЙ РАДАР ТОВАРІВ — уточнення філософії (09.08.2026)

**12_Seed_Inbox — це живий радар товарів, а не черга на закупівлю.**
Соц-джерела **безперервно збирають і СПОСТЕРІГАЮТЬ** сигнали (SIG), не ганяючи кожну знахідку одразу до постачальників. Спочатку дивимося, чи набирає товар силу, і лише потім витрачаємо гроші на Shopping, рекламу та supplier API.

### Що джерела постійно спостерігають по кожному SIG
- **кількість відео** по ніші (скільки разів товар «спливає»);
- **зміну переглядів** та **швидкість набору переглядів** (views / views_per_day);
- **повторюваність між джерелами** (той самий товар у TikTok + IG + YouTube = сильніший доказ);
- **momentum**: 🆕NEW / ⚡SPIKE / 🔥RISING / ✅PROVEN / ⚠️COOLING / 💀SATURATED;
- **first_seen / last_seen** (коли вперше побачили і чи ще живий);
- хештеги, caption, ніша, країна.

### Ключове правило
- **НЕ створюємо дублікати**: у межах одного джерела та сама ніша з різних відео → **той самий SIG** (оновлюємо лічильники/перегляди/momentum, не плодимо рядки).
- **Між джерелами** та сама ніша → **різні SIG** (зберігаємо докази) → Resolver зшиває їх у один **PRD**.

### Приклад злиття (Resolver: SIG → PRD)
YouTube «car trash can» + Instagram «car trash can» + TikTok «vehicle trash can»
→ **PRD «car trash can»**.
**Сила продукту** = 3 джерела · 12 відео · сумарні перегляди · динаміка день-до-дня · хештеги · Google Trends + пошуковий попит.

### Воронка витрат (гроші — тільки на перевірених кандидатів)
```
Соц-сигнали (безкоштовно, безперервно)  →  накопичення й спостереження SIG у радарі
   ↓ набирає силу (momentum живий + кілька джерел + зростання переглядів)
Resolver зводить SIG → PRD
   ↓ PRD проходить Google Trends (підтвердження попиту)
Тільки перспективні PRD → глибока/платна валідація:
   Google Shopping (конкуренти, ціни) · реклама · supplier API (маржа) · скоринг
```
Сенс: **платні кроки лише для товарів, що вже довели силу на радарі**. Слабкі/старі сигнали (SATURATED/COOLING) далі не йдуть.
